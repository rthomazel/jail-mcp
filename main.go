...
func run() error {
	...
	s.AddTool(
		mcp.NewTool("exec_sync",
			mcp.WithDescription("Execute a shell command (fast!). Returns stdout, stderr, exit code, and duration. Times out after "+cfg.Timeout.String()+". Most agents should use this over exec_background."),
